...
#Terminal
	#gconftool-2 --set "/apps/gnome-terminal/profiles/Default/background_image" --type string "$ScrLoc/aestheticResources/termback.jpg"
...
#Cyber Sounds	
	#sudo cp $ScrLoc/aestheticResources/gain.wav /opt/CyberPatriot/
